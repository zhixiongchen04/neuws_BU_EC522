...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_t', default=16, type=int)
    ...
    # data_dir = 'NeuWS/wavemo_data'
    # data_dir = 'NeuWS/DATA_DIR/SCENE_NAME/static_objects_static_aberrations/dog_esophagus_0.5diffuser/Zernike_SLM_data'
    ...
    for epoch in t:
        ...
        for it in range(0, len(dset), args.batch_size):
            ...
            tik_loss  = I_est.pow(2).mean()

            loss = mse_loss + lam_tik * tik_loss
            loss.backward()
    ...
    # --static_phase \
    # --num_t 16 --data_dir wavemo_data/Zernike_SLM_data  \
    # --scene_name dog_esophagus_0.5diffuser --phs_layers 4 --num_epochs 10000 --save_per_frame